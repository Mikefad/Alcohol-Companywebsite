...
import { ShoppingCart, Mail, MapPin, CheckCircle } from "lucide-react";
          ...
          <div className="max-w-2xl mx-auto bg-white p-6 rounded-2xl shadow-sm border" style={{ borderColor: COLORS.border }}>
            ...
            {submitted ? (
              <div className="text-center text-green-600">
                <CheckCircle className="inline mb-1" /> Your order has been submitted. We’ll reach out soon!
              </div>
            ) : (
              <form className="space-y-5" onSubmit={onSubmit}>
                <div>
                  ...
                  <div className="relative">
                    <ShoppingCart className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full rounded-xl border px-3 py-2 text-sm" style={{ borderColor: COLORS.border }} placeholder="E.g., 2 bottles of XYZ Whiskey" />
                </div>
